import { ItemType, type LocationModel } from "$lib/types";
export const locations: Record<string, LocationModel> = {
  ...
  "florence-county-library": {
    ...
    contents: [
      {
        type: ItemType.paragraph,
        text: "Henry Edward Davis, who worked for the city as an attorney and school board commissioner, wanted the library to be built to honor World War I veterans. In 1923, Davis helped to pass legislation that allowed funding for the public library. The Florence County Library opened in November 1925.",
      },
      {
        type: ItemType.paragraph,
        text: "Frank V. Hopkins and William Wilkins handled the architectural design. Wilkins was also responsible for creating the Poynor school, which you can learn more about on this tour.",
      },
      {
        type: ItemType.paragraph,
        text: "The building has two stories, as well as a raised basement, and is built in Neo-Classical Revival style. This style features columns, pediments, and round arches with exteriors that are symmetrical.",
      },
      {
        type: ItemType.paragraph,
        text: "The last names of prominent American writers are also featured above the windows. If you look up, you should be able to see those names. There are names of world-renowned authors such as James Fenimore Cooper, Nathaniel Hawthorne, and Edgar Allan Poe, as well as South Carolina authors like Paul Hamilton Hayne. There is also a window for Henry Timrod, a teacher in Florence, who would later have a schoolhouse and park named after him. These places are also featured in this tour.",
      },
      {
        type: ItemType.paragraph,
        text: "In July 1964, the Florence Public Library merged with the Florence County Circulating Library to create the Florence County Library system. This merger happened thanks to the efforts of the County Superintendent of Education, the Florence Public Library Board, and the South Carolina State Library. The library expanded, opening branches in the surrounding areas including Pamplico, Johnsonville, Lake City, Olanta, and Timmonsville.",
      },
      {
        type: ItemType.paragraph,
        text: "In 1977, prominent architect J. Russell Bailey was hired to recommend renovations for the building. Bailey was a proponent of modular design, and he consulted on many university libraries throughout the United States, including those at Yale University, the University of Virginia, and the University of Maryland. Bailey’s recommendations for the Florence County Library included outer expansions to wrap around three sides of the building. Local architect James Paul Barnes integrated Bailey’s recommendations into his design for the renovations.",
      },
      {
        type: ItemType.paragraph,
        text: "Visitors are not able to go inside this location, as it is now an office for the Florence School District 1. However, visitors are encouraged to park and walk around the exterior of the building to see the architectural elements."
      }
    ],
  ...
  "florence-county-museum": {
    ...
    contents: [
      {
        type: ItemType.paragraph,
        text: "In September 2008, the Florence County Museum Board was established. It was made of nine members, each from a different County District.",
      },
      {
        type: ItemType.paragraph,
        text: "Funding for the museum was granted in a three-to-one match by the State of South Carolina and then allocated by the Drs. Bruce and Lee Foundation and Florence County.",
      },
      {
        type: ItemType.paragraph,
        text: "In 2009, architects Watson Tate Savory and Cooper Robertson Partners were hired to design the building. After five years of construction, the Museum opened its doors on October 12, 2014.",
      },
      {
        type: ItemType.paragraph,
        text: "Some of the collections housed in the museum include reptile remains from the Cretaceous Period, period artifacts dating back to the Native American and Colonial periods, Civil War artifacts found from the Florence Stockade (which is also featured on this tour), and fragments of the MK-6 atomic bomb accidentally dropped on Mars Bluff in 1958.",
      },
      {
        type: ItemType.paragraph,
        text: "Next is the Wright Collection of Southern Art, formed by Ann and Louis Wright and later acquired by the Drs. Bruce and Lee Foundation. This collection includes roughly 140 works from the 20th Century. Some people included in the exhibit are Sherer Wright Royce, the daughter of Ann and Louis Wright, who is an associate professor at Coastal Carolina University. There are also pieces from Martha Severens, who used to be a curator at the Gibbs Museum of Art from 1976 until 1987. She moved to work at the Greenville County Museum for Art from 1992 until 2010, before retiring. Benjamen Zeigler, a local attorney whose family has a longstanding history in the Florence area, also has items in the collection.",
      },
      {
        type: ItemType.paragraph,
        text: "A museum tour is a great way to get an overview of the Florence area and learn some background information about many of the sites on this tour. Admission to the museum is free."
      }
    ],
  ...
  "gambles-hotel": {
    ...
    contents: [
      {
        type: ItemType.paragraph,
        text: "This site marks a Civil War skirmish that stretches over three locations in Florence. The local chapters of the United Daughters of the Confederacy installed this site marker in 1949.",
      },
      {
        type: ItemType.paragraph,
        text: "On March 5, 1865, 546 soldiers, under the command of Union Colonel Reuben Williams, fought Confederate army soldiers at this location. The soldiers were part of the 12th Indiana Infantry, a detachment from William Tecumseh Sherman’s Union Army.",
      },
      {
        type: ItemType.paragraph,
        text: "The Union soldiers outnumbered the Confederates 2 to 1, marching into Florence to destroy the railroad and its accompanying station. Doing so would allow them to cut off supplies to the Confederate army. The region had historically been known for its railroads as a primary source of transportation for plantation crops like cotton. People like Henry Johnson, the father of William Johnson who is featured on this tour, built the railways.",
      },
      {
        type: ItemType.paragraph,
        text: "Sherman’s bowties” were used to destroy the tracks. The tracks were heated and then bent into pretzel shapes. This method got its name from General Sherman, who was known for destroying railroads as a way to overpower his Confederate enemies.",
      },
      {
        type: ItemType.paragraph,
        text: "Initially, it looked as though the Union forces would be successful. One informant told a reporter from The Charleston Daily Courier that he encountered Confederate deserters trying to get home. One of the deserters told him 'the jig was up' and 'it was no use fighting any longer.'",
      },
      {
        type: ItemType.paragraph,
        text: "However, 400 reinforcements came to aid the local Confederates in fighting the Union soldiers, forcing Sherman’s troops to retreat to Darlington before they could dismantle the railways. However, they did destroy some crops before the retreat. According to The Intelligencer out of Anderson, South Carolina, 'All the cotton, both Government and private, about three thousand bales, at Florence was burned.' This was one of the two defeats Sherman had in South Carolina; the other took place in Aiken.",
      },
      {
        type: ItemType.paragraph,
        text: "Mrs. C. D. Bristow, who was still a child in 1865, recalled hearing the gunshots and seeing the soldiers glisten in the sunlight.",
      },
      {
        type: ItemType.paragraph,
        text: "Visitors are welcome to park in the open lot at Coit and Baroody, the former location of Gamble’s Hotel, and walk over to view the historical marker."
      }
    ],
  ...
  "st-johns-episcopal-church": {
    ...
    contents: [
      {
        type: ItemType.paragraph,
        text: "St. John’s Episcopal Church is one of the oldest churches in Florence. The first service for the church was hosted by Bishop Well Bell White Howe in 1865. A native of Charleston, he moved to Florence to avoid battle and to serve coastal refugees from the Civil War. The services were held in a classroom inside the Freeman Hotel, where a British widow and teacher, Frances Church, taught classes during the week. By 1866, St. John’s Parish was established, though only about 14 families were a part of the parish."
      },
      {
        type: ItemType.paragraph,
        text: "St. John’s received its name from the passing of Reverend Walter C. Guerry, who was ordained on St. John the Baptist Day. Reverend Guerry preached only once, in 1867, from the gospel according to St. John. Afterward, Reverend LeGrand Felder Guerry, Walter’s brother, took charge of the parish."
      },
      {
        type: ItemType.paragraph,
        text: "J. W. Gamble, the owner of Gamble’s Hotel, which is also featured on this tour, was an early warden of the church."
      },
      {
        type: ItemType.paragraph,
        text: "The first building for the church was built in 1871 a few blocks from downtown Florence. Services continued to be held here until 1886 when the structure of the building was damaged in an earthquake. For a time, services were then held in a Masonic Hall over a store on the corner of Evans and Dargan Street."
      },
      {
        type: ItemType.paragraph,
        text: "The current building on Dargan Street was built in 1889. The structure was designed by Silas McBee, a religious journalist who went on to edit the religious periodical The Churchman in 1896. McBee decided on a Victorian Gothic style for the church, and the first service was held just before Christmas in 1889, and in 1891, Bishop Howe consecrated the building."
      },
      {
        type: ItemType.paragraph,
        text: "Some notable figures surrounding the church include:"
      },
      {
        type: ItemType.paragraph,
        text: "William Alexander Guerry, the nephew of Walter Guerry, was bishop of the Episcopal Diocese of South Carolina. William made attempts to minister to Black congregants within the church during the Jim Crow Era. A priest who worked under Guerry, James Herbert Howard, was angered by these inclusive attempts and shot and killed William before ending his own life."
      },
      {
        type: ItemType.paragraph,
        text: "Wilmer S. “Parson” Poynor served at the church for 30 years. The local Poynor School, also featured on this tour, was named after him. In 1922, he added a parish house to the Church to prevent them from constructing a new church. Poynor also conducted the funeral service for Joseph Wallace, Sr., who once owned the Red Doe Plantation, also featured on this tour. He first retired in 1946, moved briefly to Alabama, but returned to South Carolina to take charge of Christ’s Church in Mullins before retiring again in 1950. The Florence Morning News wrote that:"
      },
      {
        type: ItemType.quote,
        text: "“He transcended denominations. The differences that set men apart were not important; it was the identities that mattered, and in all men, he found in the identity of need, whatever the church to which they belonged or didn’t belong, whatever their position in life, whatever the state of their health, whatever the color of their skin.”"
      },
      {
        type: ItemType.paragraph,
        text: "Reverend Charles Douglas “Pete” Cooper, was the parish leader of St. John’s for 20 years. During his leadership in the 1990s and early 2000s, the campus surrounding the church grew significantly. Robery Marvin made renovations to the Sunday School wing and added reinforcements for several walls. This period is also when the Schofield Library, the Fellowship Hall, the garden pavilion, and a few other additions were made."
      },
      {
        type: ItemType.paragraph,
        text: "St. John’s, whose history in the Florence area is deep and rich, celebrated its 150th anniversary on October 30, 2016. If you are visiting during regular church office hours, you may be able to request an interior tour."
      }
    ],
  ...
  "william-h-johnson-statue": {
    ...
    contents: [
      ...
      {
        type: ItemType.paragraph,
        text: "Due to his long period of failing health, his fame as an artist decreased, and some of his paintings were almost destroyed in order to make more space in his family home. Luckily, his friends saved the paintings, which is why we are able to view them in the Florence County Museum and elsewhere. Johnson lived an incredible life of artistry and travel that is important to remember, especially since this very town was his birthplace."
      },
      {
        type: ItemType.paragraph,
        text: "To visit this statue, we recommend you park in a designated parking area on the street and then walk to the Roy Adams breezeway."
      }
    ],
  ...
  "hewn-timber-cabins": {
    ...
    contents: [
      {
        type: ItemType.paragraph,
        text: "Skilled craftsmen who were enslaved on the Gregg Plantation, mentioned within John Gregg's 1839 will, built these cabins in approximately 1836. Some of these craftsmen were Eliza Davis, Simon, his wife Hannah, and Cooper Charlotte."
      },
      {
        type: ItemType.paragraph,
        text: "Originally, there were eight cabins built together, and those on the plantation referred to them collectively as 'The Street.' We do not have much information on the first enslaved people who lived here due to a fire in the plantation home, Sunnyside, in 1926 that burned all the plantation and family records."
      },
      {
        type: ItemType.paragraph,
        text: "Around roughly 1870, the cabins were expanded into second and third floors to house up to fourteen people. The fire burnt down the plantation's 'big house,' leaving four cabins, two of which were on the Francis Marion University campus. Still, we know that Catherine and Tena were among the last people to have lived in the cabins around the 1950s, hence the cabins' names."
      },
      {
        type: ItemType.paragraph,
        text: "One of the reasons these cabins are still standing is due to a method called 'dovetailing.' Dovetailing ensures that water will run away from the house when it rains. The process is difficult to produce, proving the talent of those who built it. Another key feature of their craftsmanship is called hewing."
      },
      {
        type: ItemType.paragraph,
        text: "Hewing is the process of stripping the wood to produce a flat surface, which leaves the inside of the log exposed; this exposure allows the sap produced inside of the log to serve as a natural barrier against nature, particularly bugs. Imagine having a home that is naturally protected from South Carolina mosquitoes."
      },
      {
        type: ItemType.paragraph,
      ...
      {
        type: ItemType.paragraph,
        text: "The cabins and their residents have a lasting influence throughout the Florence community. Other stops in this tour include Mt. Zion United Methodist Church, Rosenwald School, and the Mt. Zion Cemetery, places the residents of the cabin frequented."
      }
    ],
  },
  "hopewell-presbyterian-church": {
    ...
    contents: [
      ...
      {
        type: ItemType.paragraph,
        text: "Although the cemetery has not been accurately mapped, church records from the 1890s suggest that the cemetery has been in use since the church's founding. Trustees report the tradition of burying enslaved people in Hopewell cemetery, but there are no markers or depressions to support this. The Hopewell Cemetery Association formed in the 1940s to provide perpetual care of the cemetery. According to its bylaws, only those with ancestors buried here can also be interred here."
      },
      {
        type: ItemType.paragraph,
        text: "The oldest memorial marker in the cemetery is that for Mary Elizabeth Gregg who died around 1815. She was the wife of James Gregg, a captain in the American Revolutionary War and a nearby plantation owner."
      },
      {
        type: ItemType.paragraph,
        text: "In 1990, the Florence Heritage Foundation placed a historical marker for General William Wallace Harlee near the cemetery. Harlee was President of the Wilmington & Manchester Railroad and founder of the City of Florence. He named the city after his daughter. They are both buried in the cemetery. The church and cemetery were added to the National Register of Historic Places in 2000."
      }
    ]
    ,
  ...
  "mt-zion-cemetary": {
    ...
    contents: [
      {
        type: ItemType.paragraph,
        text: "Upon entering the cemetery, there is a monument that reads, \"Mount Zion United Methodist Church Cemetery Est. 1876\" on the front, and on the back is a list of names featuring the founders and members of the church."
      },
      {
        type: ItemType.paragraph,
        text: "Members of the Mt. Zion United Methodist Church established the Mt. Zion Cemetery so they would be able to bury their loved ones; this cemetery is one of the earliest existing cemeteries for the African American community in the Mars Bluff area."
      },
      {
        type: ItemType.paragraph,
        text: "The Mt. Zion Cemetery held huge significance for the community because prior to its purchase, members of the church were buried in unmarked graves. This cemetery section still exists in the far eastern corner of the acre and is known as the \"Odd Fellows Graveyard,\" in reference to The Grand United Order of Odd Fellows, an African American fraternal society, established in South Carolina during the late 1880s."
      },
      {
        type: ItemType.paragraph,
        text: "The land for the cemetery was purchased on May 20, 1876, for one dollar from R.B. Fladger, who gave the land to the Mt. Zion United Methodist Church's Board of Trustees."
      },
      {
        type: ItemType.paragraph,
        text: "Sometime after the cemetery was in use, Amelia Wallace Vernon and Louise Sallenger gifted additional land. The headstones in the foremost section of the cemetery are from the original one-acre donation, and towards the back is the land given by Wallace and Sallenger."
      },
      {
        type: ItemType.paragraph,
        text: "Some notable members of the community who were buried here, and still have headstones you can visit include Anthony Howard, Alex Gregg, Sherman Williamson, and Ernest Sellers."
      },
      {
        type: ItemType.paragraph,
        text: "Anthony H. Howard was born in 1840 and passed away in 1908. Howard was a South Carolina State Legislature Black representative in 1874, during the Reconstruction era. Howard was also a board member of the Mt. Zion United Methodist Church and was known for being a prominent Black leader in the community. Howard's headstone is a taller, thin, and rectangular shape, a stark contrast from the other headstones that are much wider. This headstone shows Howard's important role in the community he provided for as well as his wealth and status overall."
      },
      {
        type: ItemType.paragraph,
        text: "Alex Gregg, buried with his wife Emma Gregg, was born around 1845 and passed away in 1938. Gregg's life inspired the book African-Americans at Mars Bluff, South Carolina, written by Amelia Wallace Vernon. The Gregg family members were enslaved on the Gregg plantation and lived in the Hewn-Timber Cabins that remain on the Francis Marion University campus."
      },
      {
        type: ItemType.paragraph,
        text: "Sherman Willie Williamson was born in 1873 and passed away in 1950. Williamson wore many hats within the community; he was a carpenter, a butcher, a choir leader, and a trustee of the Mt. Zion Rosenwald School. Williamson married Mary Elizabeth Howard, the daughter of Anthony Howard, who passed away five years after Williamson."
      },
      {
        type: ItemType.paragraph,
        text: "Ernest Jaybuck Sellers, Sr., was born in 1910 and passed away in 1989. Due to education for Black students ending at an elementary level, Sellers only received a 6th-grade education. As Sellers got older, he served in World War II and worked for the Atlantic Coast Line Railroad. Henry Johnson, father of William Johnson, also worked for that railroad. You may learn more about them on this tour."
      },
      {
        type: ItemType.paragraph,
        text: "This cemetery is the resting place of many of Mars Bluff's leaders, and their lives are a testament to the contributions of African Americans in this part of South Carolina."
      }
    ],
  ...
  "mt-zion-united-methodist-church-rosenwald-school": {
    ...
    contents: [
      {
        type: ItemType.paragraph,
        text: "Most of the information we have for both of these sites came from the efforts of Mabel R. Dickey, researcher, writer, and member of the Mt. Zion United Methodist Church."
      },
      {
        type: ItemType.paragraph,
        text: "The first site you will see at this location is Mt. Zion United Methodist Church. Plans for this Black Church began during the American Civil War in January 1863, just after the Emancipation Proclamation freed those enslaved in the South. Several local Black leaders, including Reconstruction South Carolina State Representative Anthony Howard, officially founded it in 1868, with Reverend James Wesley Johnson as its first minister. The church was originally called the Mt. Zion Methodist Episcopal Church."
      },
      {
        type: ItemType.paragraph,
        text: "Before the church had a permanent structure, church services were held in a brush arbor. The shelter was constructed on vertical poles that had additional poles laying across the top of the shelter with branches and hay as the roof. However, the permanent structure was built in 1875. The church once had a steeple and a bell. Robert \"Bob\" Thomas was one of the first bell ringers for the church. The original church was warmed with a wood or coal-burning stove in the center."
      },
      {
        type: ItemType.paragraph,
        text: "In 1970, the church was remodeled and covered in brick veneer. This remodeling included the addition of the John A. Sellers Fellowship Hall. The hall included a pastor's study, a kitchen, and a Sunday School room. One of the trustees was Archie Waiters, who is buried in the Mt. Zion Cemetery and discussed on this tour. Members of the Waiters family have often served as trustees of the church and lived in the Hewn-Timber Cabins located on Francis Marion University's campus."
      },
      {
        type: ItemType.paragraph,
        text: "The church changed its name to Mt. Zion United Methodist Church in 1972 when the Black and white conferences merged to become the South Carolina Conference of the United Methodist Church. The church's next remodel took place in 1991, under Reverend John T. Hemingway's administration. The church installed stained glass windows, new tiles for the fellowship hall, new carpet, and cushioned seats for the pews."
      },
      {
        type: ItemType.paragraph,
        text: "Palma D. Thomas is the current reverend of the church, which is still an active place of worship today."
      },
      {
        type: ItemType.paragraph,
        text: "Across the street from the Mt. Zion United Methodist Church resides the Mt. Zion Rosenwald School."
      },
      {
        type: ItemType.paragraph,
        text: "Here, members of the then Mt. Zion Methodist Episcopal Church built the Mt. Zion School in 1870 as a school for Black children, since this was the first time that formerly enslaved people had legal access to education. Segregation meant they could not attend schools with white children in Mars Bluff, the region east of the city of Florence. The trustees of the church purchased one and three-quarter acres of land from Dr. Robert Benjamin Fladger for $35 to build a school for any child, regardless of color."
      },
      {
        type: ItemType.paragraph,
        text: "The school featured grades first through sixth, and one or two teachers led combined classes during four to five-month periods, based around times that help would be needed for farming. Unfortunately, the original school burned down in the 1920s but Julius Rosenwald then funded it to be rebuilt."
      },
      {
        type: ItemType.paragraph,
        text: "At the time, Rosenwald was the President of Sears, allowing him the funds to work towards rebuilding the school. Over 5 million dollars were spent on construction, school bus transportation, daycare programs, and donations for Black schools throughout the country. Florence's Mount Zion School is one of the few Rosenwald schools still standing and not occupied for other purposes. Rosenwald was also responsible for the design of the buildings."
      },
      {
        type: ItemType.paragraph,
        text: "The Rosenwald Fund granted the school roughly $2,000. Afterward, though, Black and white members of the community were encouraged to work together in pooling funds and building the school, including bake sales, fish fries, and other events so they would no longer need the support from the Rosenwald Fund."
      },
      {
        type: ItemType.paragraph,
      ...
      {
        type: ItemType.paragraph,
        text: "The school has three rooms. The first one is located upon entering the building. This room served as the principal's office and a small portion of it was also a classroom for fifth graders. They placed a curtain to divide the rooms."
      },
      {
        type: ItemType.paragraph,
        text: "The second room also featured a separate outside door, but the stoop outside is gone now. On the wall between the 2nd and 3rd rooms was a blackboard used in room 2, but the wall was eventually removed to create a larger space that allowed for special events to take place for the community and school programs."
      },
      {
        type: ItemType.paragraph,
        text: "The final room was at the northern end of the building, and it was approximately the same size as the second room. This room was used to teach first and second-grade students."
      },
      {
        type: ItemType.paragraph,
        text: "Some records of students who attended the school are still in existence today. Annie Lee Robinson, who also lived in the Hewn-Timber Cabins now on Francis Marion University's campus, was a student from 1947 until the school closed in 1952. Robinson started attending the Rosenwald school when she was roughly six years old. In an interview, she detailed how the students brought lunches from home and ate outside when the weather permitted. She also talked about how the students helped to gather firewood to help heat the school. The building typically ran on coal, but when it ran out, mainly the boys were sent to chop wood."
      },
      {
        type: ItemType.paragraph,
        text: "Flora James was another student who attended the school from 1946 to 1951. In a recent interview, James recalled that she and Robinson walked over a mile to and from school each day. She also talked about how they received second-hand books from nearby white schools. She has been a long-time member of the Mt. Zion United Methodist Church and worked at Francis Marion University in her adulthood."
      },
      {
        type: ItemType.paragraph,
        text: "The history of the Mt. Zion Church and the Rosenwald School is still recent enough that people today have memories of attending the school and upkeeping the church."
      }
    ],
  ...
  "red-doe-plantation": {
    ...
    contents: [
      {
        type: ItemType.paragraph,
        text: "In 1839, John Gregg gave his 1,005-acre plantation to his son Evander Gregg, who was 18 years old. John’s younger son, J. Eli owned the neighboring Gregg Plantation.",
      },
      {
        type: ItemType.paragraph,
        text: "Evander’s plantation home was built sometime between 1839 and 1846. It is a one-story frame farmhouse on a raised brick foundation and is an example of a traditional raised Carolina cottage with its basement and porch form.",
      },
      {
        type: ItemType.paragraph,
        text: "In 1860, Gregg still owned only 650 acres of the original land and enslaved 38 people who primarily grew cotton. He owned the land until 1867, when he sold it and moved following the American Civil War.",
      },
      {
        type: ItemType.paragraph,
        text: "The land was purchased by Robert Legare and Sarah Jane Evans Singletary. Legare was a Captain in the 8th Infantry for the Confederacy during the Civil War. Both of them are buried at the Hopewell Presbyterian Church Cemetery, which is also a point of interest on this tour.",
      },
      {
        type: ItemType.paragraph,
        text: "Next, the land would be passed on to Joseph Wallace and his wife Sallie Gregg Wallace. The couple owned Florence Dry Goods in Mars Bluff and were members of St. John’s Episcopal Church, also featured on this tour.",
      },
      {
        type: ItemType.paragraph,
        text: "Wallace then sold the house to his brother-in-law, Reverend Thomas Hartwell Edwards, who then deeded it to Joseph Wallace’s three sons: Walter, Marion Chisholm, and Joseph, Jr.",
      },
      {
        type: ItemType.paragraph,
        text: "In the 1930s, Joseph Wallace, Jr., the middle son, began calling the plantation Red Doe. This was in reference to a Revolutionary War incident when Patriot scout Andrew Hunter escaped on a horse named “Red Doe” belonging to Loyalist Colonel David Fanning. In 1782, Colonel Fanning captured Hunter while he was scouting in North Carolina. Hunter managed to pull off a daring escape by stealing Fanning´s horse and taking his saddle, holsters, pistols, and papers. After the war, Hunter went on to work in the South Carolina House of Representatives and served on commissions for roads, navigation, and a new courthouse and jail.",
      },
      {
        type: ItemType.paragraph,
        text: "The house was restored between 1940 and 1941 by Marion Chisholm Wallace and his wife Annie Pearce Wallace. Marion was the great-grandnephew of Evander Gregg. After many years, the Red Doe Plantation continuously found itself in the hands of the Gregg family. The Wallaces renovated the property. It was featured in the Florence Homes and Gardens Tour in 1967, and the Wallaces received the Florence Harllee Silver Cup Award for its preservation efforts in 1979. In 1982, 9 acres of the plantation were added to the National Register of Historic Places.",
      },
      {
        type: ItemType.paragraph,
        text: "Then, in 2006, Robert Wilkins donated the land to a nonprofit organization, the Pee Dee Rifles, a local chapter of the Sons of Confederate Veterans, for preservation. They hoped to make it into a museum, but the group was unable to raise enough funds. However, the group did host annual “living history” events at the plantation for several years. Funny enough, the Pee Dee Region Paranormal investigators even visited Red Doe in 2007.",
      },
      {
        type: ItemType.paragraph,
        text: " In 2009, Florence City and the County Historical Commission erected a historical marker on the site, which you are encouraged to read.",
      },
      {
        type: ItemType.paragraph,
        text: "In 2014, restoration work began on the property with grant money from the South Carolina Department of Transportation, with the help of the Drs. Bruce and Lee Foundation, and focused on stabilizing the stairs and cypress columns. The Drs. Bruce and Lee Foundation also helped fund the museum and library that are featured on this tour.",
      },
      {
        type: ItemType.paragraph,
        text: "In 2017, the Palmetto Trust for Historic Preservation put the plantation up for sale at $150,000. Bought by Chelsea and Josh Guthrie, the plantation is now called Red Doe Farm & Events. As recently as 2021, the site has been used as a venue for weddings and other special occasions.",
      },
    ],
  ...
  "union-cemetary": {
    ...
    contents: [
      {
        type: ItemType.paragraph,
        text: "The Union Cemetery was first known as the Ministerial Union Cemetery, as it was not associated with just one church but several within the Florence area.",
      },
      {
        type: ItemType.paragraph,
        text: "The cemetery was commissioned by Charles Taylor and Clayton Brown in March 1917 during World War I. Taylor was the president and minister of Trinity Baptist Church, and Brown was the minister of Cumberland AME Church, now known as the Cumberland United Methodist Church.",
      },
      {
        type: ItemType.paragraph,
        text: "The following month, plans were drawn for the cemetery. In April 1918, the men paid a thousand dollars to James Daniel Evans to obtain 6 acres of land. Evans was a local white attorney whose sister, Jane Evans, helped found the Florence Museum (not to be confused with the Florence County Museum).",
      },
      {
        type: ItemType.paragraph,
        text: "Some people of interest buried here include:",
      },
      {
        type: ItemType.paragraph,
        text: "The parents of William H. Johnson, whose graves for many years were unmarked. Now, there is an 8-foot tall memorial statue for the couple, which has an engraving of a painting that Johnson did of his parents.",
      },
      {
        type: ItemType.paragraph,
        text: "Reverend Clayton R. Brown and his wife, Elizabeth, who passed away in 1933 and 1941. Reverend Brown was one of the aforementioned founders who helped to establish the cemetery.",
      },
      {
        type: ItemType.paragraph,
        text: "Reverend Charles Theodore Taylor and his wife, Theresa O. Brown, who passed away in 1935 and 1942. Reverend Taylor also helped to establish the cemetery. He gave the church nineteen years of service, and it prospered both spiritually and financially as never before. During that time, the membership practically doubled, and on one occasion, two hundred members were baptized the same day.",
      },
      {
        type: ItemType.paragraph,
        text: "Washington Gero Brown passed away in 1948 and was placed in a segregated burial ground. He served in the first World War from September 1918 until July 1919. Wounded twice, he was a South Carolina Private in the 802 Pioneer Infantry. The Pioneer Infantry was similar to regular army troops in that they were trained in infantry tactics.",
      },
      {
        type: ItemType.paragraph,
        text: "However, the troops were also trained in combat engineering; twenty of the thirty-seven Pioneer Infantry Regiments were comprised of African-American soldiers. These men often built bridges and roads, which kept them within the lower ranks of the military. These segregated regiments represented the role that racial discrimination played in the U.S. during this time.",
      },
      {
        type: ItemType.paragraph,
        text: "Resting places like the Union Cemetery tell us a lot about the communities they serve. They are particularly important for learning about the histories of African American communities, as their histories were not well-documented during the era of segregation. This cemetery tells us about businesses, faith leaders, freemasons, and veterans as well as families. Many of the Black leaders of early Florence rest here, and many of their descendants continue to be buried in this cemetery.",
      },
    ],
  }
};